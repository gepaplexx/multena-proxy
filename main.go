...
func configureProxy(originBypassServerURL *url.URL, tenantLabel string, originServerURL *url.URL, tokenExchangeURL string) http.HandlerFunc {
	return func(rw http.ResponseWriter, req *http.Request) {
		...
		if ((keycloakToken.Groups != nil && keycloakToken.Groups[0] == os.Getenv("ADMIN_GROUP")) || utils.Contains(keycloakToken.ApaGroupsOrg, os.Getenv("ADMIN_GROUP"))) && strings.ToLower(os.Getenv("TOKEN_EXCHANGE")) == "true" {
